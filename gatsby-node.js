...
exports.createPages = ({ graphql, actions }, themeOptions) => {
  // const devBlogPath = themeOptions.devBlogPath || path.resolve('./src/pages')
              ...
              edges {
                node {
                  fields {
                    ...
                    # langKey
                    directoryName
                    # maybeAbsoluteLinks # only needed for i18n
                  }
                  frontmatter {
                    title
                  }
...
exports.onCreateNode = ({ node, actions, getNode }) => {
  ...
  const { content, ...noContent } = node.internal
  // console.log({
  //   // node,
  //   nodeInternal: noContent,
  //   // content,
  //   // nodeInternal: Object.keys(node.internal),
  //   // get: _.get(node, 'internal.type'),
